...
class SeasonScraper:
    def __init__(self):
        ...
        self.master_table_fpath = os.path.join(get_project_root(), "data", "season_list.csv")
    ...
    def add_season_numbers_to_master(self, master_table : pd.DataFrame) -> pd.DataFrame:
        ...
        for current_ep, next_ep in zip(season_eps, season_eps[1:]):  # pairwise iteration
        ...
        for season_vals in episode_ids_in_season:
            ...
            if n_prev_eps == 0:
                ...
                master_table.loc[n_prev_eps:n_prev_eps + n_current_eps, 'Season Number'] = season_number
